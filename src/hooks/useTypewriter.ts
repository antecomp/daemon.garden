 ...
 */
const useTypewriter = (inputText: string | null | undefined, delay = 50, onComplete = (): void => {}) => { // Giving onComplete this default to prevent weird behavior I had in the JS implementation.
